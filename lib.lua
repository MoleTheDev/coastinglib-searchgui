...
function Library:CreateTab(name)
	...
	function Library:CreateSearchTab(name)
		local NameTab = Instance.new("Frame")
		local NameTabButton = Instance.new("ImageButton")
		local Title = Instance.new("TextLabel")
		local SectionLayout = Instance.new("UIListLayout")
		...
		Items.Name = "Items"
		Items.Parent = NameTab
		Items.Active = true
		Items.AnchorPoint = Vector2.new(0.5, 0)
		Items.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		Items.BackgroundTransparency = 1.000
		Items.BorderSizePixel = 0
		Items.Position = UDim2.new(0.498812497, 0, 0.116751269, 0)
		Items.Size = UDim2.new(0.997624934, 0, 0.825714946, 5)
		...
		button.BorderColor3 = Color3.fromRGB(32, 32, 32)
		button.BorderSizePixel = 2
		button.Position = UDim2.new(0.5, 0, 0.0250000004, 0)
		button.Size = UDim2.new(1, 0, 0.0500000007, -5)
		button.ZIndex = 2
		...
		SearchBar.Position = UDim2.new(-0.682897687, 499, -0.000380694866, 0)
		SearchBar.Size = UDim2.new(0.995249569, 0, 0.075000003, 0)
		SearchBar.ZIndex = 2
		...
		local function RDQH_fake_script() -- Items.LocalScript 
